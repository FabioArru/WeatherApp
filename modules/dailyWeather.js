...
export function displayCurrentWeather(weather, city){
    ...
    <div class = "weather-info">
        ...
        <h3 class="weather-data"><i class="fas fa-location-arrow" style = "transform : rotate(${WEATHER.wind_deg}deg)"></i> ${WEATHER.windSpeed}km\\h</h3>
    ...
    weatherIcon(currentWeatherIcon, WEATHER.mainWeather);
